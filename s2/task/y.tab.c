...
{
       0,    24,    24,    36,    42,    43,    45,    46,    47,    50,
      53,    56,    59,    60,    61,    62,    63,    64,    65
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "READ", "WRITE", "NUM",
  "ID", "ASSIGN", "PLUS", "MINUS", "MUL", "DIV", "BEG", "SEMICOLON", "END",
  "'('", "')'", "$accept", "program", "SLIST", "STMT", "INPUTSTMT",
  "OUTPUTSTMT", "ASSIGNSTMT", "expr", YY_NULLPTR
};
...
{
      -9,    -2,    10,    11,    25,    18,     7,     5,   -16,   -16,
     -16,   -16,   -16,    35,    12,    12,   -16,    15,   -16,    27,
     -16,   -16,    12,    13,    26,   -16,    29,    22,    12,    12,
      12,    12,    31,   -16,   -16,   -16,    -5,    -5,   -16,   -16,
     -16
};
...
{
      24,     3,     4,     1,     5,    30,    31,    27,     3,     4,
      12,     5,     6,    36,    37,    38,    39,    20,    21,    17,
      16,    28,    29,    30,    31,    15,    13,    22,    25,    32,
      28,    29,    30,    31,    28,    29,    30,    31,    35,    33,
      14,    19,    34,    26,    40,    18
};

static const yytype_int8 yycheck[] =
{
      15,     3,     4,    12,     6,    10,    11,    22,     3,     4,
       0,     6,    14,    28,    29,    30,    31,     5,     6,    14,
      13,     8,     9,    10,    11,     7,    15,    15,    13,    16,
       8,     9,    10,    11,     8,     9,    10,    11,    16,    13,
      15,     6,    13,    16,    13,     7
};
...
{
       0,    12,    18,     3,     4,     6,    14,    19,    20,    21,
      22,    23,     0,    15,    15,     7,    13,    14,    20,     6,
       5,     6,    15,    24,    24,    13,    16,    24,     8,     9,
      10,    11,    16,    13,    13,    16,    24,    24,    24,    24,
      13
};
...
#line 1246 "y.tab.c"
  ...
  case 11: /* ASSIGNSTMT: ID ASSIGN expr SEMICOLON  */
#line 56 "exprnTree.y"
...
#line 59 "exprnTree.y"
                                {(yyval.node) = createTree(noVal, noType, NULL, plusNode,(yyvsp[-2].node),(yyvsp[0].node));}
#line 1258 "y.tab.c"
    break;

  case 13: /* expr: expr MINUS expr  */
#line 60 "exprnTree.y"
                                {(yyval.node) = createTree(noVal, noType, NULL, minusNode,(yyvsp[-2].node),(yyvsp[0].node));}
#line 1264 "y.tab.c"
    break;

  case 14: /* expr: expr MUL expr  */
#line 61 "exprnTree.y"
                                {(yyval.node) = createTree(noVal, noType, NULL, mulNode,(yyvsp[-2].node),(yyvsp[0].node));}
#line 1270 "y.tab.c"
    break;

  case 15: /* expr: expr DIV expr  */
#line 62 "exprnTree.y"
                                {(yyval.node) = createTree(noVal, noType, NULL, divNode,(yyvsp[-2].node),(yyvsp[0].node));}
#line 1276 "y.tab.c"
    break;
